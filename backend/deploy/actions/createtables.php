<?php
	...
	mysqli_query($con, "CREATE TABLE users (id int NOT NULL AUTO_INCREMENT, username varchar(255), email varchar(255), encryptedPassword varchar(255), hash varchar(255), verified int, isPrivate int, createdDateTime datetime, PRIMARY KEY (id))") or die(error());
	mysqli_query($con, "CREATE TABLE loginTokens (id int NOT NULL AUTO_INCREMENT, userId int, token varchar(255), device varchar(255), datetime_tab datetime, PRIMARY KEY (id))") or die(error());
